# Onyedika Peter - Full Stack and Mobile Software Developer
...
![AssemblyAI](https://img.shields.io/badge/AssemblyAI-000000?style=flat-square)
...
### Automation, Scraping and Realtime
...
![GitHub Stats](https://github-stats-extended.vercel.app/api?username=onyedika-glitch&show_icons=true&theme=dark&hide_border=true)

![Top Languages](https://github-stats-extended.vercel.app/api/top-langs/?username=onyedika-glitch&layout=compact&theme=vision-friendly-dark)
...
* **Mobile Application Development**: Flutter and Dart cross platform mobile apps for iOS and Android with Firebase and push notifications
* **High Performance Backend APIs**: FastAPI Python microservices, Laravel backends, Express.js, and Fastify server platforms
* **Full Stack Web Development**: End to end web application architecture and production deployment
* **AI Tooling and Integrations**: DeepSeek, OpenAI, Gemini, and AssemblyAI pipelines with prompt engineering
* **Browser Extension Engineering**: Chrome Extension Manifest V3 in page side panels and session bridges
* **FinTech and Payment Gateways**: Bachs checkout sessions, HMAC webhooks, Paystack, and Stripe integrations
* **Automation and Web Scraping**: FastAPI, Playwright, Puppeteer, and Selenium data pipelines
* **Containerization and Cloud DevOps**: Docker compose, Nginx, and cloud platform deployments
